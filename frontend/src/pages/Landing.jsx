        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="relative z-10">
            <motion.span
              ...
              className="inline-flex rounded-full border border-emerald-400/25 bg-emerald-500/10 px-4 py-2 text-sm font-medium uppercase tracking-[0.35em] text-emerald-300"
            >
            ...
            >
              Verify charities, NGOs and fundraising campaigns before donating
              using AI-powered credibility analysis.
            </motion.p>
            ...
            >
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-emerald-400 to-emerald-500 px-6 py-3 text-sm font-semibold text-slate-950 shadow-glow transition hover:scale-[1.01]"
              >
                Verify Now
              ...
              <Link
                to="/history"
                className="inline-flex items-center justify-center rounded-full border border-white/15 bg-white/5 px-6 py-3 text-sm font-semibold text-slate-100 transition hover:border-emerald-400/40 hover:bg-white/10"
              >
                View History
              </Link>
            </motion.div>
            ...
            >
              {[
                ...
                <div
                  key={item.label}
                  className="rounded-3xl border border-white/10 bg-slate-950/70 px-5 py-4 text-sm text-slate-300 shadow-xl shadow-black/20 transition hover:border-emerald-400/30 hover:bg-slate-900/80"
                >
          ...
          <motion.div
            ...
            className="relative z-10 overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-b from-slate-900/80 to-slate-950/95 p-8 shadow-glow"
          >
            ...
            <div className="flex h-full flex-col justify-between gap-6 rounded-[2rem] border border-white/10 bg-slate-950/95 p-6 backdrop-blur-xl">
              <div className="rounded-[1.75rem] bg-slate-900/70 p-8 shadow-2xl shadow-emerald-900/20">
                <div className="flex items-center justify-between gap-4">
                  <span className="rounded-3xl bg-emerald-500/10 px-4 py-2 text-sm text-emerald-300">
                    Live AI Insights
                  </span>
                  <span className="rounded-2xl bg-white/5 px-3 py-1 text-xs uppercase tracking-[0.24em] text-slate-300">
                    Beta
                  </span>
                </div>
                ...
                <div className="mt-8 flex items-center justify-between gap-6">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-slate-400">
                      Average trust score across verified NGOs
                    </p>
                  </div>
              ...
              <div className="rounded-[1.75rem] border border-white/10 bg-slate-900/70 p-6 shadow-xl shadow-black/20">
                <div className="flex items-center gap-3 text-sm text-slate-400">
                  ...
                  <div>
                    ...
                    <p>
                      Secure your donation decisions with instant credibility
                      analysis.
                    </p>
                  </div>
                </div>
